...
#region OpenGL identifiers
    ...
    public static class Raylib
    {
        ...
        {
            return Harvesturr.Utils.PtrToStringUTF8(INTERNAL_GetMonitorName(monitor));
        }
        ...
        {
            return Harvesturr.Utils.PtrToStringUTF8(INTERNAL_GetClipboardText());
        }
        ...
        {
            return Harvesturr.Utils.PtrToStringUTF8(INTERNAL_GetGamepadName(gamepad));
        }
